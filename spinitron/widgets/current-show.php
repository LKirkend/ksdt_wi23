...
<?php if(strcmp($currentTime, $start->format('d:ga')) == 0) { ?>
    <span class="spinitron pt-sm-4 pb-0 pt-md-0 mw-fit" id="show" onclick="redirectClick(this)" href="https://spinitron.com/KSDT/show/<?=$show['id']?>"><?= htmlspecialchars($show['title'], ENT_NOQUOTES) ?><br></span>
